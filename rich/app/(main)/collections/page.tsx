...
export default function FashionCollection() {
 ...
 { icon: Shirt, label: "Premium Brands", value: "2+" },
  ...
  return (
    <section className="relative w-full min-h-screen bg-gradient-to-br from-black via-slate-900 to-blue-950 py-12 lg:py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
      {/* Enhanced Background */}
